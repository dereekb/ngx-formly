import * as _ngx_formly_core_types_ngx_formly_core from '@ngx-formly/core/types/ngx-formly-core';
...
declare function withFormlyBootstrap(): _ngx_formly_core_types_ngx_formly_core.ConfigOption[];

declare class FormlyBootstrapModule {
