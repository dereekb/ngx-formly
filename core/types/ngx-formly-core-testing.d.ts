...
declare function createComponent<T>({ template, inputs, config, detectChanges, imports, declarations, providers, }: IComponentOptions<T>): T & {
...
declare function createFieldComponent(field: FormlyFieldConfig, config?: IComponentOptions<{
